const iconLoc = '../assets/icons/'
const imgLoc = '../assets/images/'


export const AppImages = {
    // appLogo: require(iconLoc + 'logo.png'),
    ...
    homeItems:{
        item1:require(imgLoc+ 'home1.png'),
        item2:require(imgLoc+ 'home2.png'),
        item3:require(imgLoc+ 'home3.png'),
        item4:require(imgLoc+ 'home4.png'),
        item5:require(imgLoc+ 'home5.png'),
        item6:require(imgLoc+ 'home6.png'),
        item7:require(imgLoc+ 'home7.png'),
        item8:require(imgLoc+ 'home8.png'),
    }
